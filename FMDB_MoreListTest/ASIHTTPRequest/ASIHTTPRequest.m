...
- (void)updateDownloadProgress
{
    ...
    if (bytesReceivedBlock) {
        ...
        [self performBlockOnMainThread:^{
            if (bytesReceivedBlock) {
                bytesReceivedBlock(value, totalSize);
            }
        }];
    }
#endif
...
- (void)updateUploadProgress
{
    ...
    if (bytesSentBlock) {
        ...
        [self performBlockOnMainThread:^{
            if (bytesSentBlock) {
                bytesSentBlock(value, totalSize);
            }
        }];
    }
#endif
...
- (void)removeUploadProgressSoFar
{
    ...
    if (bytesSentBlock) {
        ...
        [self performBlockOnMainThread:^{
            if (bytesSentBlock) {
                bytesSentBlock(progressToRemove, totalSize);
            }
        }];
    }
#endif
...
#endif
    [self performSelector:@selector(failAuthentication)
